...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,   KC_C,    KC_V,    KC_B,    KC_BSPC, KC_DEL,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS, \
                            KC_LALT, LOWER,   KC_LGUI, KC_SPC,  KC_ENT,   RAISE,   KC_RGUI, KC_ESC \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_F11,  KC_F12,  KC_PSCR, KC_SLCK, KC_PAUS,                   XXXXXXX, KC_P7,   KC_P8,   KC_P9,   KC_PPLS, KC_PAST, \
  _______, KC_LPRN, KC_RPRN, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, KC_P4,   KC_P5,   KC_P6,   KC_PMNS, KC_PSLS, \
  _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, XXXXXXX, _______, _______, KC_0,    KC_P1,   KC_P2,   KC_P3,   KC_PENT, XXXXXXX, \
